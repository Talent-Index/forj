...
export const sections = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        reference: REFS.l1s,
        funFact: "Teams launch L1s when they need custom gas, privacy, or throughput the shared C-Chain cannot give one app.",
      },
      {
        id: "e8",
        topic: "validators",
      ...
      },
      {
        ...
        options: [
          ...
          "Because it runs the Solana VM only",
          "Because it rejects all Ethereum RPCs",
          "Because it is a Bitcoin script interpreter",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Mine with GPUs",
          "Run an Ethereum beacon node only",
          "Pay Bitcoin transaction fees",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "A random NFT marketplace",
          "The Bitcoin Core GUI only",
          "Etherscan's Ethereum-only docs",
        ],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "m3",
        topic: "fundamentals",
        question: "What does the X-Chain primarily handle within Avalanche?",
        ...
        explanation:
          "The Exchange Chain issues and transfers Avalanche Native Tokens using a UTXO model. AVAX itself is one of those assets. After the Cortina upgrade the X-Chain uses linear Snowman consensus rather than the old DAG engine.",
        reference: REFS.xChain,
      ...
      },
      {
        ...
        options: [
          ...
          "A GPU miner",
          "The P-Chain staking UI only",
          "A Bitcoin ordinals standard",
        ],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explanation:
          "The C-Chain runs Coreth, an Ethereum Virtual Machine implementation wrapped by Snowman++. Solidity, Hardhat, and MetaMask work with chain IDs 43114 (mainnet) and 43113 (Fuji). Other VMs can run on custom L1s.",
        reference: REFS.coreth,
      ...
      },
      {
        ...
        explanation:
          "AVAX transaction fees are burned. The C-Chain uses an EIP-1559-style base fee inside Coreth; burning reduces circulating supply as activity rises instead of transferring those fees to a miner set.",
        reference: REFS.coreth,
      ...
      },
      {
        ...
        options: [
          "It provides native message delivery between Avalanche chains and L1s",
          "It is only a wallet UI theme",
          "It replaces the need for AVAX entirely",
          "It is a Bitcoin ordinals standard",
        ],
        answer: "It provides native message delivery between Avalanche chains and L1s",
        hint: "Think authenticated messages between Avalanche networks.",
        explanation:
          "Origin validators sign a payload with BLS keys; signatures aggregate into one proof. The destination verifies against P-Chain validator weights. There is no required global message bus on the Primary Network.",
        reference: REFS.icm,
      ...
      },
      {
        ...
        options: [
          ...
          "The X-Chain UTXO wallet seed format",
          "A proof-of-work miner",
          "The Bitcoin difficulty algorithm",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Mandatory GPU puzzles",
          "A permanent single leader",
          "Weekly social-media polls",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Manual DNS edits only",
          "An Ethereum L1 deposit contract",
        ],
      ...
      },
      {
        id: "h13",
        topic: "tooling",
        question: "Which current CLI is documented for P-Chain staking, subnet creation, and L1 validators?",
        options: ["Platform CLI", "Bitcoin Core CLI", "npm only", "Solana CLI"],
        answer: "Platform CLI",
        hint: "Builder Hub marks the older Avalanche-CLI as deprecated for these jobs.",
        explanation:
      ...
      },
      {
        ...
        options: [
          ...
          "Burns the entire stake immediately",
          "Seizes the operator's hardware",
          "Rewrites the AVAX cap",
        ],
